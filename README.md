...
- Agent builder architecture with pluggable LLM/STT/TTS providers.
- Telephony + CRM + payment integration registry and extension points.
- Campaign queue architecture with BullMQ/Redis.
